...
public class SparkOffsetRecovery implements Serializable{

    private static SparkOffsetRecovery app = new SparkOffsetRecovery();
...
//        JavaStreamingContext streamingContext = JavaStreamingContext.getOrCreate(checkpointDir, createContextFunc);
        ...
        JavaStreamingContext streamingContext = createContextFunc();
...
//      Generate the schema based on the string of schema
    ...
    public JavaDStream<String> getKafkaInputStream(JavaStreamingContext streamingContext) {
        ...
        logdata.checkpoint(new Duration(5000));
        return logdata;
    }
